...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/add-liquidity/:pool_address?', name: 'mint1', component: Mint1 },
    { path: '/add-liquidity-2/:pool_address?', name: 'mint2', component: Mint2 },
    { path: '/remove-liquidity/:pool_address?', name: 'burn', component: Burn },
